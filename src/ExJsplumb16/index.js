...
export default class ExJsplumb16 extends Component {
  constructor() {
    super();
    this.state = {
  ...
  componentDidMount() {
    jsplumb.jsPlumb.ready(function () {
        ...
        instance.batch(function () {
            ...
            instance.draggable(jsplumb.jsPlumb.getSelector(".flowchart-demo .window"), { grid: [20, 20] });
      ...
      <>
       <div className="jtk-demo-main">
            ...
            <div className="jtk-demo-canvas canvas-wide flowchart-demo jtk-surface jtk-surface-nopan" id="canvas">
                <div className="window jtk-node" id="flowchartWindow1"><strong>1</strong><br/><br/></div>
                <div className="window jtk-node" id="flowchartWindow2"><strong>2</strong><br/><br/></div>
                <div className="window jtk-node" id="flowchartWindow3"><strong>3</strong><br/><br/></div>
                <div className="window jtk-node" id="flowchartWindow4"><strong>4</strong><br/><br/></div>
            </div>
        </div>
      </>
    );
