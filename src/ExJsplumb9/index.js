...
export default class ExJsplumb9 extends Component {
  constructor() {
    super();
    this.state = {
    ...
    jsplumb.jsPlumb.ready(function() {
      ...
      instance.batch(function() {
        var connections = {
          ...
          divsWithWindowClass = jsplumb.jsPlumb.getSelector(".dynamic-demo .window");
  ...
  render() {
    ...
    <div className="jtk-demo-canvas canvas-wide dynamic-demo jtk-surface jtk-surface-nopan" id="canvas">
      <div className="window" id="dynamicWindow1">
        <strong>1</strong><br/><br/></div>
      <div className="window" id="dynamicWindow2">
        <strong>2</strong><br/><br/></div>
      <div className="window" id="dynamicWindow3">
        <strong>3</strong><br/><br/></div>
      <div className="window" id="dynamicWindow4">
        <strong>4</strong><br/><br/></div>
      <div className="window" id="dynamicWindow5">
        <strong>5</strong><br/><br/></div>
      <div className="window" id="dynamicWindow6">
