...
export default class ExJsplumb8 extends Component {
  constructor() {
    super();
    this.state = {
  ...
  componentDidMount() {
    ...
    instance.batch(function() {
      ...
      instance.addEndpoint(
        jsplumb.jsPlumb.getSelector(".drag-drop-demo .window"),
        exampleEndpoint3
      );
      var hideLinks = jsplumb.jsPlumb.getSelector(".drag-drop-demo .hide");
      instance.on(hideLinks, "click", function(e) {
        instance.toggleVisible(this.getAttribute("rel"));
        jsplumb.jsPlumbUtil.consume(e);
      });
      var dragLinks = jsplumb.jsPlumb.getSelector(".drag-drop-demo .drag");
      instance.on(dragLinks, "click", function(e) {
        var s = instance.toggleDraggable(this.getAttribute("rel"));
        this.innerHTML = s ? "disable dragging" : "enable dragging";
        jsplumb.jsPlumbUtil.consume(e);
      });
      var detachLinks = jsplumb.jsPlumb.getSelector(".drag-drop-demo .detach");
  ...
  render() {
    ...
    <div className="jtk-demo-canvas canvas-wide drag-drop-demo jtk-surface jtk-surface-nopan" id="canvas">
      <div className="window" id="dragDropWindow1">one<br/><br/>
        <a href="#" className="cmdLink hide" rel="dragDropWindow1">toggle connections</a><br/>
        <a href="#" className="cmdLink drag" rel="dragDropWindow1">disable dragging</a><br/>
        <a href="#" className="cmdLink detach" rel="dragDropWindow1">detach all</a>
      </div>
      <div className="window" id="dragDropWindow2">two<br/><br/>
        <a href="#" className="cmdLink hide" rel="dragDropWindow2">toggle connections</a><br/>
        <a href="#" className="cmdLink drag" rel="dragDropWindow2">disable dragging</a><br/>
        <a href="#" className="cmdLink detach" rel="dragDropWindow2">detach all</a>
      </div>
      <div className="window" id="dragDropWindow3">three<br/><br/>
        <a href="#" className="cmdLink hide" rel="dragDropWindow3">toggle connections</a><br/>
        <a href="#" className="cmdLink drag" rel="dragDropWindow3">disable dragging</a><br/>
        <a href="#" className="cmdLink detach" rel="dragDropWindow3">detach all</a>
      </div>
      <div className="window" id="dragDropWindow4">four<br/><br/>
        <a href="#" className="cmdLink hide" rel="dragDropWindow4">toggle connections</a><br/>
        <a href="#" className="cmdLink drag" rel="dragDropWindow4">disable dragging</a><br/>
        <a href="#" className="cmdLink detach" rel="dragDropWindow4">detach all</a>
      </div>
      <div id="list"></div>
    </div>
  </div>
